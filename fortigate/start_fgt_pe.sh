...
export FGT_IP_SERVER=192.168.80.41
export FGT_MAC_SERVER=08:00:27:4c:80:41
...
sudo virsh net-define virbr_client
sudo virsh net-start virbr_client
sudo virsh net-autostart virbr_client
sudo virsh net-define virbr_server
sudo virsh net-start virbr_server
sudo virsh net-autostart virbr_server
...
--filesystem ${PWD},shared_dir --import --name ${FGT_NAME} \
--cpu host,-vmx \
