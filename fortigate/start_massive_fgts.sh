...
<network>
  ...
  <bridge name='mpls_a' stp='off' delay='0'/>
  <mac address='52:54:00:79:7c:c3'/>
  <ip address='172.16.${server_id}.1' netmask='255.255.255.0'>
    <dhcp>
      <range start='172.16.${server_id}.2' end='172.16.${server_id}.254'/>
    </dhcp>
  </ip>
</network>
EOF
sudo virsh net-create mpls_a
